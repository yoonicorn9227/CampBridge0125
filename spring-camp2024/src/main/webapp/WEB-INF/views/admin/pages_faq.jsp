...
<body>
  ...
  <main id="main" class="main">
    ...
    <div class="pagetitle">
      ...
      <nav>
        <ol class="breadcrumb">
          <li class="breadcrumb-item"><a href="adminPage"></a>관리자페이지 홈</li>
      ...
      <div class="row">
        <div class="col-lg-6">
          ...
          <div class="card basic">
            <div class="card-body">
              <h5 class="card-title">자주 묻는 질문 Top 3</h5>

              <div>
                <h6>1. "예약을 취소하고 싶어요."</h6>
                <p>예약자 본인이 직접 예약 확인/취소 가능합니다.<br>예약/결제 당시 안내된 취소/환불 규정에 따라 처리되며,<br>취소수수료 발생 시 취소수수료를 차감한 금액으로 환불 처리됩니다.</p>
              </div>

              <div class="pt-2">
              <h6>2. "천재지변으로 인한 예약취소는 어떻게 하나요?"</h6>
              <p>일반적인 우천에 의한 예약 취소 및 변경은 불가합니다.<br>태풍 등 기상 특보 시, 입실 당일 현장 날씨 및 캠핑장/펜션의 정책에 따라<br>연기 또는 취소 결정됩니다.<br>입실 당일 오전에 캠핑장/펜션에 연락하셔서 안내받으시기 바랍니다.</p>
              </div>

              <div class="pt-2">
                <h6>3. "입실일을 변경하고 싶어요."</h6>
                <p>예약 당일 변경은 불가능합니다.<br>취소 수수료를 확인하시고 기존 예약건을 취소하신 다음 재예약하셔야 합니다.</p>
              </div>
          ...
          <div class="card">
            <div class="card-body">
              <h5 class="card-title">기타 자주 묻는 질문</h5>
                ...
                <div class="accordion-item">
                  <h2 class="accordion-header">
                    <button class="accordion-button collapsed" data-bs-target="#faqsOne-1" type="button" data-bs-toggle="collapse">
                      "객실 타입(사이트)을 변경하고 싶어요."
                    </button>
                  </h2>
                  <div id="faqsOne-1" class="accordion-collapse collapse" data-bs-parent="#faq-group-1">
                    <div class="accordion-body">
                      캠브릿지 고객센터(070-1234-5678)로 문의하시기 바랍니다.
                    </div>
                  </div>
                </div>
                ...
                <div class="accordion-item">
                  <h2 class="accordion-header">
                    <button class="accordion-button collapsed" data-bs-target="#faqsOne-2" type="button" data-bs-toggle="collapse">
                      "취소수수료 산정 기준은 어떻게 되나요?"
                    </button>
                  </h2>
                  <div id="faqsOne-2" class="accordion-collapse collapse" data-bs-parent="#faq-group-1">
                    <div class="accordion-body">
                      취소수수료는 숙소별로 상이합니다.<br>취소수수료는 예약 시점과는 무관하게 입실일로부터 남은 날짜 기준으로 부과되며,<br>결제하신 금액에서 취소수수료를 차감한 금액이 환불됩니다.
                      <br>환불 예정 금액은 조회 시점 또는 실제 환불 진행 시점에 따라 달라질 수 있으므로,<br>예약/결제 진행 당시 안내된 취소/환불 규정을 반드시 숙지해주시길 바랍니다.
                    </div>
                  </div>
                </div>
                ...
                <div class="accordion-item">
                  <h2 class="accordion-header">
                    <button class="accordion-button collapsed" data-bs-target="#faqsTwo-1" type="button" data-bs-toggle="collapse">
                      [공지] 12/29 고객센터 단축운영 및 1/1 신정 휴무 안내
                    </button>
                  </h2>
                ...
                <div class="accordion-item">
                  <h2 class="accordion-header">
                    <button class="accordion-button collapsed" data-bs-target="#faqsTwo-5" type="button" data-bs-toggle="collapse">
                      [공지] 예약문자 오발송 안내(9/15 오후 2시 해결 완료)
                    </button>
                  </h2>
                ...
                <div class="accordion-item">
                  <h2 class="accordion-header">
                    <button class="accordion-button collapsed" data-bs-target="#faqsThree-1" type="button" data-bs-toggle="collapse">
                      [필독] 2024년 02월 강원도 춘천 오로라 캠핑장에서 장박 고객 모집 받습니다.
                    </button>
                  </h2>
